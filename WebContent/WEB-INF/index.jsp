...
<div class="container">
    <div id="content">
        ...
        <!-- 登录的表单 -->
        <form action="<%=localPath%>/login" id="loginform" method="post" class="layui-form" style="text-align: center;margin-right:12%;margin-top:10%;">
            ...
            <div>
                ...
                <div style="text-align:center;color: #009688;background-color: #01AAED;width:48%;margin-left:138px;">
                    <input type="submit" class="layui-btn layui-btn-lg" style="background: none;" value="登    录"/>
                </div>
            </div>
        </form>
        <!-- 注册的表单 -->
        <form action="<%=localPath%>/register" id="registerform" method="post" class="layui-form" hidden="hidden" style="text-align: center;margin-right:12%;margin-top:10%;">
            <div>
                <div class="layui-form-item layui-inline" style="width:110%">
                    <label class="layui-form-label" style="margin-left:13%;"><i class="fa fa-user fa-fw"></i></label>
                    <div class="layui-input-inline">
                ...
                <div style="text-align:center;color: #009688;background-color: #01AAED;width:48%;margin-left:34%;">
                    <input type="button" class="layui-btn layui-btn-lg" style="background: none;" value="注    册" onclick="validate()"/>
                </div>
            </div>
        </form>
        ...
        if(a_name != ''){
            $.post(
               ...
               function(result){
                   ...
                   if(jsonData == null){
                        $("#info").text("可以注册").css({'color':'green','font-size':'13px'});
                        return true;
                   }
                   if(jsonData != null){
                        $("#info").text("该用户名已注册").css({'color':'red','font-size':'13px'});
                        return false;
                    }
            });
        }
